...
Built using PHP and MySQL, the system centralizes activity scheduling, attendance tracking, student management, and unit transparency into a secure and structured digital platform.
 ...
 ->Activity Creation & Editing with custom unique Activity ID generation
 
 ->Bulk Attendance Marking in a single transaction
 
 ->Dynamic Attendance Percentage for students
 
 ->Unit-Based Data Filtering for secure access
